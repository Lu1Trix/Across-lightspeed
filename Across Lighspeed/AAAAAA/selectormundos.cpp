...
selectormundos::selectormundos(QSound* Sonidos,int NaveUsada, QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::selectormundos)
{
    ...
    scene->setBackgroundBrush(QPixmap(":/Selectores/SelectorMundos.png").scaled(800,600));
